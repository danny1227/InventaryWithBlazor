        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WherehouseAddress = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "WarehouseId", "WarehouseName", "WherehouseAddress" },
                values: new object[,]
                {
                    { "WH1", "Aseo Hogar", "zona 01" },
                    { "WH2", "Electrónicos", "zona 01" },
                    { "WH3", "Reparaciones", "zona 01" },
                    { "WH4", "Cultura", "zona 01" },
                    { "WH5", "Deportes", "zona 01" },
                    { "WH6", "Alimentación", "zona 01" },
                    { "WH7", "Hogar y Muebles", "zona 01" },
                    { "WH8", "Ropa", "zona 01" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "P1", "ASH", "Lavadora de ropa", "Lavadora", 10 },
                    { "P2", "ELC", "Televisor de 50 pulgadas", "Televisor", 10 },
                    { "P3", "RPR", "Reparación de PC", "Reparación de PC", 10 },
                    { "P4", "CLT", "Libro de programación", "Libro", 10 },
                    { "P5", "SPR", "Balón de fútbol", "Balón de fútbol", 10 },
                    { "P6", "FDN", "Arroz", "Arroz", 10 },
                    { "P7", "HME", "Sofá de 3 puestos", "Sofá", 10 },
                    { "P8", "CLT", "Camisa de vestir", "Camisa", 10 }
                });
